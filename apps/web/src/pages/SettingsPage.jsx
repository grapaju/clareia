              ...
              <Tabs defaultValue="uso" orientation="vertical" className="grid gap-6 md:grid-cols-[220px_minmax(0,1fr)]">
                ...
                <div className="min-w-0">
                  ...
                  <TabsContent value="visual" className="mt-0 space-y-5">
                    ...
                    <Field label="Tamanho do texto"><Select value={preferences.textSize} onValueChange={(value) => update({ textSize: value })}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="normal">Normal</SelectItem><SelectItem value="grande">Grande</SelectItem><SelectItem value="maior">Maior</SelectItem></SelectContent></Select></Field>
